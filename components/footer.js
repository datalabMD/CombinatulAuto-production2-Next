        ...
        <div className="footer-max-width max-content-container">
          <div className="footer-banner">
            ...
            <div className="footer-btns-container">
              <Link href="/">
                <a className="footer-link button-primary button-lg button">
                  servicii
                </a>
              </Link>
              <a
          ...
          <div className="footer-bottom-container">
            <div className="footer-left-side">
              ...
              <div className="footer-social-media">
                <span className="footer-text07">urmareste -ne</span>
            ...
            <div className="footer-links">
              <div className="footer-container1">
                <Link href="/">
                  <a className="footer-link02">servicii</a>
                </Link>
                <Link href="/">
                  <a className="footer-link03">spalatorie auto</a>
                </Link>
                <Link href="/transport">
                  <a className="footer-link04">TRANSPORT AUTO</a>
                </Link>
                <Link href="/">
                  <a className="footer-link05">parcare auto</a>
                </Link>
                <Link href="/arenda-spatii">
                  <a className="footer-link06">ARENDA SPATIILOR</a>
                </Link>
                <Link href="/alimentarea-publica">
                  <a className="footer-link07">ALIMENTATIE PUBLICA</a>
                </Link>
              </div>
              <div className="footer-container2">
                <span className="footer-text08">Reparatii auto</span>
              ...
              <div className="footer-container3">
                <Link href="/reparatii-auto">
                  <a className="footer-link08">Reparatii auto</a>
                </Link>
                <Link href="/reparatii-auto">
                  <a className="footer-link09">diagnosticare</a>
                </Link>
                <Link href="/reparatii-auto">
                  <a className="footer-link10">motoare</a>
                </Link>
                <Link href="/reparatii-auto">
                  <a className="footer-link11">caroserii</a>
                </Link>
                <Link href="/reparatii-auto">
                  <a className="footer-link12">radiatoare</a>
                </Link>
                <Link href="/reparatii-auto">
                  <a className="footer-link13">acumulatoare</a>
                </Link>
              </div>
            </div>
          </div>
